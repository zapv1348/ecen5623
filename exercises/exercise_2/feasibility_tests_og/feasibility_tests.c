...
unsigned int Deadline(U32_T time, U32_T deadline){
    return deadline-time;
}

unsigned int Laxity(U32_T deadline, U32_T comp){
...
int LLF_sched(U32_T numServices, U32_T period[], U32_T wcet[], U32_T deadline[])
{
    ...
    for(k=0;k<=LCM;k++){
        ...
        for(i=0;i<numServices;i++){
            ...
            Laxity[i]=Dead_TM[i]-comp_rem[i];
            /*if(s<20){
                printf("task:%d, lax,%d",i,Laxity[i]);
                s++;
            }*/
        }
        //if(s<20)printf("\n");
        ...
        for(i=0;i<numServices;i++){
            ...
            /*
            if(s<56){
                printf("cycle: %d,task: %d, laxity: %d, dead: %d, comp: %d\n",k,i,Laxity[i],Dead_TM[i],comp_rem[i]);
                s++;
            }*/
            if(Dead_TM[i]<comp_rem[i]){
                return FALSE;
